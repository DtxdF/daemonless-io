...
*Versions last checked: 2026-03-21T13:35:12.038764Z*
...
| :material-check-circle:{ .current } | [mariadb](images/mariadb.md) | `pkg` | 11.4.9 | [:simple-githubactions:](https://github.com/daemonless/mariadb/actions/workflows/build.yaml) |
| :material-check-circle:{ .current } | [mariadb](images/mariadb.md) | `pkg-latest` | 11.4.10 | [:simple-githubactions:](https://github.com/daemonless/mariadb/actions/workflows/build.yaml) |
| :material-check-circle:{ .current } | [mariadb](images/mariadb.md) | `pkg` | 11.8.5 | [:simple-githubactions:](https://github.com/daemonless/mariadb/actions/workflows/build.yaml) |
| :material-check-circle:{ .current } | [mariadb](images/mariadb.md) | `pkg-latest` | 11.8.6 | [:simple-githubactions:](https://github.com/daemonless/mariadb/actions/workflows/build.yaml) |
...
| :material-check-circle:{ .current } | [postgres](images/postgres.md) | `pkg` | 14.22 | [:simple-githubactions:](https://github.com/daemonless/postgres/actions/workflows/build.yaml) |
| :material-check-circle:{ .current } | [postgres](images/postgres.md) | `pkg-latest` | 14.22 | [:simple-githubactions:](https://github.com/daemonless/postgres/actions/workflows/build.yaml) |
| :material-check-circle:{ .current } | [postgres](images/postgres.md) | `pkg` | 17.9 | [:simple-githubactions:](https://github.com/daemonless/postgres/actions/workflows/build.yaml) |
| :material-check-circle:{ .current } | [postgres](images/postgres.md) | `pkg-latest` | 17.9 | [:simple-githubactions:](https://github.com/daemonless/postgres/actions/workflows/build.yaml) |
| :material-check-circle:{ .current } | [postgres](images/postgres.md) | `pkg` | 18.3 | [:simple-githubactions:](https://github.com/daemonless/postgres/actions/workflows/build.yaml) |
| :material-check-circle:{ .current } | [postgres](images/postgres.md) | `pkg-latest` | 18.3 | [:simple-githubactions:](https://github.com/daemonless/postgres/actions/workflows/build.yaml) |
